...
public class SeparateChainingHashST<Key, Value> {
    ...
    private int K; //limite da media das chains
    private int lgM; //piso do log base 2 de M. Calculado de acordo com a documentacao do java
    ...
    public SeparateChainingHashST(int M) {
        this.M = M;
        lgM = 31 - Integer.numberOfLeadingZeros(M);
        K = 10;
        st = (SequentialSearchST<Key, Value>[]) new SequentialSearchST[M];
        for (int i = 0; i < M; i++)
            st[i] = new SequentialSearchST<Key, Value>();
    }
    //Construtor que recebe M e K, K sendo limite da media das chains.
    ...
    //Funcao que retorna os tamanhos de cada uma das M chains.
    public int[] getSizes() {
        int[] a = new int[M];
        for(int i = 0; i < M; i++)
            a[i] = st[i].size();
    ...
    public static void main(String[] args) {
        SeparateChainingHashST<String, Integer> st = new SeparateChainingHashST<String, Integer>(4, 10);
